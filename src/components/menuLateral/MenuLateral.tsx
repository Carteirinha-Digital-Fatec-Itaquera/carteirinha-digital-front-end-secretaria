...
function MenuLateral({ collapsed, setCollapsed }: MenuLateralProps) {
  ...
  return (
    <nav
      className={`${styles.fundoMenu} ${
        collapsed ? styles.fundoMenuCollapsed : ""
      }`}
      onClick={() => {
    ...
    >
      <header>
        ...
        <ul
          className={`${styles.estiloLista} ${
            collapsed ? styles.estiloListaCollapsed : ""
          }`}
        >
          {/* Lista de alunos */}
          <li
            className={`${styles.itemMenu} ${
              collapsed ? styles.itemMenuCollapsed : ""
            } ${selected === "listaAlunos" ? styles.selected : ""}`}
            onClick={(e) => {
              e.stopPropagation();
          ...
          {collapsed ? (
            <li
              className={`${styles.itemMenu} ${
                styles.itemMenuCollapsed
              } ${
                selected === "registroManual" ||
                selected === "registroImport"
                  ? styles.selected
                  : ""
              }`}
          ...
          <li
            className={`${styles.itemMenu} ${
              collapsed ? styles.itemMenuCollapsed : ""
            } ${selected === "perfil" ? styles.selected : ""}`}
            onClick={(e) => {
              e.stopPropagation();
          ...
          <li
            className={`${styles.itemMenu} ${
              collapsed ? styles.itemMenuCollapsed : ""
            } ${selected === "fotos" ? styles.selected : ""}`}
            onClick={(e) => {
              e.stopPropagation();
              handleMenuClick("/fotos");
            }}
