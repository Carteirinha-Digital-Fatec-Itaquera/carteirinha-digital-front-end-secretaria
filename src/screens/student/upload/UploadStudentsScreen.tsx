...
export default function UploadStudentsScreen() {
  ...
  const handleUpload = async () => {
    ...
    if (!file) {
      ...
      // ALTERADO
      toast.warning(
        "Selecione um arquivo XLSX, CSV, TXT ou PDF"
      );
        ...
        <div className={styles.container}>
          ...
          <div className={styles.card}>
            ...
            <div className={styles.caixaUpload}>
              ...
              <label
                htmlFor="fileUpload"
                className={styles.inputArquivoArea}
              >
            ...
            {result && (
              ...
              <div className={styles.containerResultado}>
                ...
                <p>
                  ...
                  {" "}
                  <span className={styles.cadastrados}>
                    {result.sucesso}
                  </span>
                </p>
                ...
                <p>
                  Erros:
                  {" "}
                  <span className={styles.numErros}>
