...
export default function StudentsListScreen() {
  ...
  const filteredStudents = useMemo(() => {
    return students.filter((s) => {
      const matchSituacao =
        !situacaoFilter || s.status === situacaoFilter;

      const matchCurso =
        !cursoFilter || s.course === cursoFilter;
    ...
    <LayoutWithMenu>
      <div className={styles.container}>
        ...
        <AlertModalComp
          ...
          message={
            "Você deseja aprovar ou reprovar esta imagem? (Esta acão é irreversível)"
          }
          textCancel="Reprovar"
          textConfirm="Aprovar"
          onConfirm={async () => {
